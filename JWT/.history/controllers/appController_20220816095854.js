  ...
  (req, res) => {
    ...
    Account.getAccount(decoded.id, (result) => {
      res.send({
        Token: theToken,
        data: result[0],
        avatar: "https://images.unsplash.com/photo-1660569833895-afa346764cfc?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
        decoded,
      });
    });
  });
